...
const BENEFITS = [
  ...
  { Icon: IconBadge, title: "Reviewed by Licensed Professionals", body: "Every recommendation is checked by a licensed agent before you apply." },
];
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {BENEFITS.map((b) => (
            <div key={b.title} className="rounded-2xl bg-canvas-alt p-7 text-center">
              <span className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-canvas-raised text-harbor shadow-[0_1px_2px_rgba(18,33,64,0.1)]">
