const FAQS = [
  ...
  },
  {
    ...
    a: "Most people choose an amount that covers a funeral and burial or cremation, which commonly runs $8,000–$15,000, plus a cushion for any outstanding bills. A licensed professional can help you size it to your situation instead of guessing.",
  },
  {
      ...
      <div className="mx-auto max-w-4xl px-5 py-20 sm:px-8 sm:py-28">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
            Before you start, the professional answers.
          </h2>
        </div>
