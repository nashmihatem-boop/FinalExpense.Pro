const POINTS = [
  ...
  },
  {
    ...
    body: "Most policies are “simplified issue” — a handful of health questions, no exam, no bloodwork. Coverage decisions are reviewed and typically come back in minutes, not weeks.",
  },
  {
