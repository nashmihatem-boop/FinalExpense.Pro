...
const STEPS = [
  ...
  {
    n: "2",
    title: "A licensed professional reviews your options",
    body: "We match your answers to carriers that fit, and a licensed agent calls to walk through a professional recommendation of what you actually qualify for — no pressure, no script.",
  },
  {
    n: "3",
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
            Three steps, one professional call.
          </h2>
        </div>

        <ol className="mt-14 grid gap-8 sm:grid-cols-3">
          {STEPS.map((step) => (
            <li key={step.n} className="rounded-2xl bg-canvas-raised p-7 shadow-[0_1px_2px_rgba(18,33,64,0.08)]">
