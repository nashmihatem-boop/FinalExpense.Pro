    ...
    <section className="bg-canvas-alt">
      <div className="mx-auto max-w-4xl px-5 py-16 text-center sm:px-8 sm:py-20">
        ...
        <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-charcoal/75">
          ...
          live. We&apos;ve built a dedicated, professionally researched guide for every state so
          you can see your local options before you talk to anyone.
        </p>
        ...
        <div className="mx-auto mt-8 flex max-w-md flex-col items-center gap-3 sm:flex-row">
          <select
            ...
            className="w-full rounded-full border border-mist bg-canvas-raised px-5 py-3 text-sm font-semibold text-harbor shadow-[0_1px_2px_rgba(18,33,64,0.08)] focus:border-harbor-mid focus:outline-none"
          >
