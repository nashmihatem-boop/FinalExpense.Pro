...
const SCENARIOS = [
  {
    ...
    body: "Not sure where to start? We'll walk you through how it works and provide a professional assessment of what fits your situation, with no pressure to decide today.",
  },
  {
    Icon: IconTrendingDown,
    title: "Looking to lower your payments",
    body: "Already have a policy? We can evaluate it against current offers to see if there's a better rate for the same coverage.",
  },
  {
    Icon: IconTrendingUp,
    title: "Need more coverage than you have",
    body: "If your existing policy would leave a gap, we'll help you size additional coverage to close it, backed by a professional review.",
  },
  {
    Icon: IconGift,
    ...
    <section className="bg-canvas">
      <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
        ...
        <p className="mt-12 text-center font-display text-lg font-bold text-harbor">
          Wherever you are in the process, you&apos;ll get a professional recommendation.
        </p>
      </div>
    </section>
  );
