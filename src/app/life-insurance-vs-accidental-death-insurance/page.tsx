...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of why accidental death insurance only pays for accidents — not illness or natural causes — and why that distinction matters, especially later in life.",
  openGraph: { title: "Life Insurance vs. Accidental Death Insurance", description: "A professional explanation of why accidental death insurance only pays for accidents — not illness or natural causes — and why that distinction matters, especially later in life." },

  twitter: { title: "Life Insurance vs. Accidental Death Insurance", description: "A professional explanation of why accidental death insurance only pays for accidents — not illness or natural causes — and why that distinction matters, especially later in life." },
};
