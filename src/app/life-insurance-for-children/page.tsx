...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how small whole life policies and riders for children work, why families buy them, and how they differ from senior-focused final expense coverage.",
  openGraph: { title: "Life Insurance for Children, Explained", description: "A professional explanation of how small whole life policies and riders for children work, why families buy them, and how they differ from senior-focused final expense coverage." },

  twitter: { title: "Life Insurance for Children, Explained", description: "A professional explanation of how small whole life policies and riders for children work, why families buy them, and how they differ from senior-focused final expense coverage." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          this site. Here&apos;s a professional explanation of what it actually is, and
          isn&apos;t.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          for, it&apos;s worth asking a licensed professional directly, since it&apos;s a distinct
          product from what most of this site is written around.
        </p>
