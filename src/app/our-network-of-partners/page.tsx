...
export const metadata: Metadata = {
  ...
  description: "Who your information may be shared with when you submit a request on FinalExpense.Pro.",
  robots: { index: false, follow: true },
  openGraph: { title: "Our Network of Partners — FinalExpense.Pro" },
  twitter: { title: "Our Network of Partners — FinalExpense.Pro" },
};
...
export default function OurNetworkOfPartnersPage() {
  return (
    <LegalPage title="Our Network of Partners" updated="September 24, 2026">
      <p>
        FinalExpense.Pro is operated by {siteConfig.legalEntity}. When you submit a request on
