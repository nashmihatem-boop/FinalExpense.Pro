...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how insurers decide what to offer and at what price, and how simplified-issue underwriting for final expense insurance differs from a fully underwritten traditional policy.",
  openGraph: { title: "How Life Insurance Underwriting Works", description: "A professional explanation of how insurers decide what to offer and at what price, and how simplified-issue underwriting for final expense insurance differs from a fully underwritten traditional policy." },

  twitter: { title: "How Life Insurance Underwriting Works", description: "A professional explanation of how insurers decide what to offer and at what price, and how simplified-issue underwriting for final expense insurance differs from a fully underwritten traditional policy." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          takes effect. Here&apos;s a professional explanation of what that process actually
