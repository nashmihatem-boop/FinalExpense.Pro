...
const DEFAULT_TITLE = "FinalExpense.Pro — Expert Final Expense Insurance Guidance";
const DEFAULT_DESCRIPTION =
  "Get expert guidance on final expense life insurance coverage in minutes. No medical exam for most applicants. Answer a few quick questions to see your options, reviewed by licensed professionals.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: DEFAULT_TITLE,
    template: "%s — FinalExpense.Pro",
  },
  description: DEFAULT_DESCRIPTION,
  openGraph: {
    type: "website",
    siteName: "FinalExpense.Pro",
    title: DEFAULT_TITLE,
    description: DEFAULT_DESCRIPTION,
    url: SITE_URL,
    locale: "en_US",
