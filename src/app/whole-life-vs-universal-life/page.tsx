...
export const metadata: Metadata = {
  ...
  description:
    "A professional comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits.",
  openGraph: { title: "Whole Life vs. Universal Life Insurance", description: "A professional comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits." },

  twitter: { title: "Whole Life vs. Universal Life Insurance", description: "A professional comparison of whole life and universal life insurance — fixed guarantees versus flexible premiums — and where final expense insurance fits." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          built for different priorities, and a licensed professional can help weigh which one
          actually fits yours.
        </p>
