...
export const metadata: Metadata = {
  ...
  description:
    "Professional, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to considering direct burial — and why coverage still matters even with a simple plan.",
  openGraph: { title: "How to Reduce Funeral Costs", description: "Professional, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to considering direct burial — and why coverage still matters even with a simple plan." },

  twitter: { title: "How to Reduce Funeral Costs", description: "Professional, honest ways to reduce funeral costs — from knowing your rights under the FTC Funeral Rule to considering direct burial — and why coverage still matters even with a simple plan." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          people realize going in. A few practical, professional steps — most of them about asking
          the right questions rather than cutting corners — can make a meaningful difference.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          planned service can be paired with unexpected expenses, which is exactly the gap a
          professionally arranged final expense policy is built to cover: cash paid directly to
          your family, usable for whatever actually comes up. See{" "}
