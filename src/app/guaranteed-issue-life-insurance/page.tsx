...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how guaranteed-issue (guaranteed-acceptance) life insurance actually works, why it carries a waiting period, why it costs more, and who it's really built for.",
  openGraph: { title: "Guaranteed Issue Life Insurance Explained", description: "A professional explanation of how guaranteed-issue (guaranteed-acceptance) life insurance actually works, why it carries a waiting period, why it costs more, and who it's really built for." },

  twitter: { title: "Guaranteed Issue Life Insurance Explained", description: "A professional explanation of how guaranteed-issue (guaranteed-acceptance) life insurance actually works, why it carries a waiting period, why it costs more, and who it's really built for." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          first with a licensed professional, since it tends to cost less for the same coverage
          and typically doesn&apos;t carry a waiting period. See our{" "}
