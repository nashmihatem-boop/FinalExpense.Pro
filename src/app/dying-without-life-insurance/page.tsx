...
export const metadata: Metadata = {
  ...
  description:
    "A professional, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place.",
  openGraph: { title: "What Happens If You Die Without Life Insurance", description: "A professional, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place." },

  twitter: { title: "What Happens If You Die Without Life Insurance", description: "A professional, plain-language look at who ends up covering funeral and final expenses when there's no life insurance policy in place." },
};
  ...
  return (
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A life insurance or final expense policy, put in place with professional guidance,
          exists specifically to close this gap before it opens. Instead of family members
          covering costs out of pocket and sorting out reimbursement later, a named beneficiary
          can typically receive the death benefit in cash within days of a claim being filed —
          money that&apos;s theirs to use immediately, with no probate process required first. It
          doesn&apos;t prevent the loss. It just means the people left behind aren&apos;t also
          left with the bill.
        </p>
