...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how the graded step-up payout works in the first couple of years, what health profile typically lands here, and why it's real, valid coverage.",
  openGraph: { title: "Graded Benefit Final Expense Insurance Explained", description: "A professional explanation of how the graded step-up payout works in the first couple of years, what health profile typically lands here, and why it's real, valid coverage." },

  twitter: { title: "Graded Benefit Final Expense Insurance Explained", description: "A professional explanation of how the graded step-up payout works in the first couple of years, what health profile typically lands here, and why it's real, valid coverage." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          out on a schedule rather than all at once for the first stretch. Here&apos;s a
          professional explanation of exactly how the step-up works, why carriers use it, and who
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          time, of which carriers tend to be more favorable to your specific history. A licensed
          professional can check that before you formally apply. And if your history points
