...
export const metadata: Metadata = {
  ...
  description:
    "Yes — a professional explanation of how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention.",
  openGraph: { title: "Can You Have More Than One Life Insurance Policy?", description: "Yes — a professional explanation of how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention." },

  twitter: { title: "Can You Have More Than One Life Insurance Policy?", description: "Yes — a professional explanation of how holding multiple life insurance policies actually works, why people do it, and when it can draw extra underwriting attention." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          it&apos;s technically large enough on paper. A dedicated final expense policy, arranged
          with professional guidance, closes that specific gap without touching what your other
          coverage is meant to do. See{" "}
