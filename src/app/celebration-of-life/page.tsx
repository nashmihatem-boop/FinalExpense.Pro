...
export const metadata: Metadata = {
  ...
  description:
    "A professional look at how a celebration of life compares to a traditional funeral, what it can include, and how it fits with burial or cremation plans.",
  openGraph: { title: "What Is a Celebration of Life Service?", description: "A professional look at how a celebration of life compares to a traditional funeral, what it can include, and how it fits with burial or cremation plans." },

  twitter: { title: "What Is a Celebration of Life Service?", description: "A professional look at how a celebration of life compares to a traditional funeral, what it can include, and how it fits with burial or cremation plans." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          Here&apos;s a professional look at what typically sets it apart, and how it fits
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          already available, through a life insurance or final expense policy arranged with
          professional guidance, gives a family room to plan the kind of service that actually
          fits, rather than being limited to whatever is most affordable in the moment.
        </p>
