...
export const metadata: Metadata = {
  ...
  description:
    "A professional, balanced look at who final expense insurance is genuinely a good fit for, and who might not need it.",
  openGraph: { title: "Is Final Expense Insurance Worth It?", description: "A professional, balanced look at who final expense insurance is genuinely a good fit for, and who might not need it." },

  twitter: { title: "Is Final Expense Insurance Worth It?", description: "A professional, balanced look at who final expense insurance is genuinely a good fit for, and who might not need it." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          Here&apos;s a genuinely balanced, professional look at both sides, so you can decide for
          yourself.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          that already cover this is mostly redundant cost, not added protection — and any
          licensed professional worth trusting should tell you that plainly rather than sell you
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          have you actually had a professional check whether the amount is enough once you account
          for more than just the funeral itself, like outstanding medical bills or other debts?
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          either side of it. If you want a second opinion, a licensed professional can help you
          look at your specific situation — what you already have, what it would actually cost to
          fill the gap, and whether it&apos;s worth doing — at no charge and no obligation,
