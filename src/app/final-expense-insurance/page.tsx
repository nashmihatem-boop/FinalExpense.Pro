...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how final expense (burial) insurance works, the two main policy types, what affects your premium, and how to apply.",
  openGraph: { title: "Final Expense Insurance Explained", description: "A professional explanation of how final expense (burial) insurance works, the two main policy types, what affects your premium, and how to apply." },

  twitter: { title: "Final Expense Insurance Explained", description: "A professional explanation of how final expense (burial) insurance works, the two main policy types, what affects your premium, and how to apply." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          Final expense insurance, explained by professionals
        </h1>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          you need full coverage in place, which is exactly what a professional review is meant
          to sort out.
        </p>

        <PolicyTypesTable />
        <p className="mt-4 text-sm leading-relaxed text-charcoal/60">
          Exact numbers vary by carrier, state, and your personal details — a licensed
          professional can tell you exactly what you qualify for and what it costs, at no charge.
        </p>
        ...
        <ol className="mt-6 space-y-5">
          <li className="flex gap-4">
            ...
            <p className="text-base leading-relaxed text-charcoal/80">
              ...
              health, coverage amount, and contact information — that&apos;s the review request on
              this site, and it takes about two minutes.
            </p>
          </li>
          <li className="flex gap-4">
            ...
            <p className="text-base leading-relaxed text-charcoal/80">
              <strong className="text-harbor">A licensed professional reaches out.</strong>{" "}
              They&apos;ll compare options across our carrier partners and walk you through what
              you actually qualify for — including price, coverage amount, and whether you&apos;d
        ...
        <div className="mt-14 rounded-2xl bg-canvas-alt p-7">
          ...
          <p className="mt-3 text-base leading-relaxed text-charcoal/80">
            FinalExpense.Pro specializes in expert, professional guidance on life insurance and
            final expense insurance for seniors who want peace of mind knowing their funeral
            expenses won&apos;t burden their loved ones. We partner with multiple providers so we
            can compare dozens of plans side by side to find the best value for each customer,
            instead of pointing everyone toward a single company&apos;s policy regardless of fit.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-charcoal/60">
            How we&apos;re paid: when you enroll in a policy through one of our licensed
            professional partners, that carrier compensates the agency. That&apos;s standard
            across the industry, and it never changes your premium or comes out of your pocket —
            getting a professional coverage review is free either way.
          </p>
        </div>
