...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of costs beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income — that many families don't think about until it's too late.",
  openGraph: { title: "The Hidden Costs of Dying Families Don't Plan For", description: "A professional breakdown of costs beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income — that many families don't think about until it's too late." },

  twitter: { title: "The Hidden Costs of Dying Families Don't Plan For", description: "A professional breakdown of costs beyond the funeral itself — probate, medical bills, debt, final utility payments, family travel, and lost income — that many families don't think about until it's too late." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-8 text-base leading-relaxed text-charcoal/80">
          ...
          costs are exactly the kind of thing a modest life insurance policy, arranged with
          professional guidance, is built to absorb: cash paid directly to your beneficiary,
          usable for whatever actually comes up, rather than restricted to a funeral home&apos;s
          invoice.
        </p>
