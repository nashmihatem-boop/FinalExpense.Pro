...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of who can be named a life insurance beneficiary, the difference between primary and contingent beneficiaries, and why keeping this information current matters.",
  openGraph: { title: "What Is a Beneficiary?", description: "A professional explanation of who can be named a life insurance beneficiary, the difference between primary and contingent beneficiaries, and why keeping this information current matters." },

  twitter: { title: "What Is a Beneficiary?", description: "A professional explanation of who can be named a life insurance beneficiary, the difference between primary and contingent beneficiaries, and why keeping this information current matters." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          request to your insurance company or licensed professional, and it doesn&apos;t require
          rewriting the policy itself.
        </p>
