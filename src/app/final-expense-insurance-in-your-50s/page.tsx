...
export const metadata: Metadata = {
  ...
  description:
    "A professional look at why your 50s are often the easiest decade to qualify for final expense insurance, and how locking in a rate now compares with waiting.",
  openGraph: { title: "Final Expense Insurance in Your 50s", description: "A professional look at why your 50s are often the easiest decade to qualify for final expense insurance, and how locking in a rate now compares with waiting." },

  twitter: { title: "Final Expense Insurance in Your 50s", description: "A professional look at why your 50s are often the easiest decade to qualify for final expense insurance, and how locking in a rate now compares with waiting." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-8 text-lg leading-relaxed text-charcoal/80">
          ...
          insurance — but it&apos;s one of the more common ages to first request a professional
          review, and often the easiest decade to get approved at the best rate a carrier offers.
          Here&apos;s what&apos;s actually different about applying now instead of waiting.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          friendliest stretch for the outcome most applicants actually want.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          retirement age. The professional answer is that there&apos;s no minimum age where it
          starts making sense — it comes down to whether you already have savings set aside for
          final costs, and whether you want to make sure that expense never lands on your family,
