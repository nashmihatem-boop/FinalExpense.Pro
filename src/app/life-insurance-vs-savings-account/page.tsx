...
export const metadata: Metadata = {
  ...
  description:
    "A professional comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both.",
  openGraph: { title: "Life Insurance vs. a Savings Account", description: "A professional comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both." },

  twitter: { title: "Life Insurance vs. a Savings Account", description: "A professional comparison: a savings account only holds what you've deposited. A life insurance policy can pay its full amount from day one. Here's how to think about both." },
};
