...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of what a life insurance death benefit is, how it's paid, whether it's taxable, and what it can actually be used for.",
  openGraph: { title: "What Is a Death Benefit?", description: "A professional explanation of what a life insurance death benefit is, how it's paid, whether it's taxable, and what it can actually be used for." },

  twitter: { title: "What Is a Death Benefit?", description: "A professional explanation of what a life insurance death benefit is, how it's paid, whether it's taxable, and what it can actually be used for." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          the applicant at the time of purchase, based on what they&apos;re trying to cover, ideally
          with professional guidance. For a policy meant to handle end-of-life costs specifically,
          that&apos;s usually a more modest amount than a policy meant to replace years of income.
          See{" "}
