...
export const metadata: Metadata = {
  ...
  description:
    "A professional comparison of how final expense insurance and term life insurance actually differ — underwriting, coverage length, what each is built to pay for, and how to decide.",
  openGraph: { title: "Final Expense vs. Term Life Insurance", description: "A professional comparison of how final expense insurance and term life insurance actually differ — underwriting, coverage length, what each is built to pay for, and how to decide." },

  twitter: { title: "Final Expense vs. Term Life Insurance", description: "A professional comparison of how final expense insurance and term life insurance actually differ — underwriting, coverage length, what each is built to pay for, and how to decide." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          professional, closer look at what actually separates them.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          walks through in full, with a licensed professional guiding the decision either way.
        </p>
