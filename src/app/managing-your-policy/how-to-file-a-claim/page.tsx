...
export const metadata: Metadata = {
  ...
  description:
    "A professional, step-by-step guide to how a beneficiary files a life insurance claim, from locating the policy to submitting paperwork.",
  openGraph: { title: "How to File a Death Benefit Claim", description: "A professional, step-by-step guide to how a beneficiary files a life insurance claim, from locating the policy to submitting paperwork." },

  twitter: { title: "How to File a Death Benefit Claim", description: "A professional, step-by-step guide to how a beneficiary files a life insurance claim, from locating the policy to submitting paperwork." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          process is more paperwork than complexity — here is a professional, plain breakdown of
          the general steps, so you know what to expect.
        </p>
