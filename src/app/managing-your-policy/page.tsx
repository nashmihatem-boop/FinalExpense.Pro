...
export const metadata: Metadata = {
  ...
  description:
    "Already have a final expense or life insurance policy? Get professional help with claims, beneficiaries, missed payments, cash value, and more.",
  openGraph: { title: "Managing Your Policy", description: "Already have a final expense or life insurance policy? Get professional help with claims, beneficiaries, missed payments, cash value, and more." },

  twitter: { title: "Managing Your Policy", description: "Already have a final expense or life insurance policy? Get professional help with claims, beneficiaries, missed payments, cash value, and more." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          This section isn&apos;t about shopping for coverage — it&apos;s professional guidance for
          people who already have a final expense or life insurance policy and need help with
          something specific: a missed payment, a claim, an outdated beneficiary, or a question
          about how the policy actually works. Pick a topic below.
        </p>
