...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of what the standard two-year contestability period means, why it exists, and how it differs from a graded or modified waiting period.",
  openGraph: { title: "The Life Insurance Contestability Period, Explained", description: "A professional explanation of what the standard two-year contestability period means, why it exists, and how it differs from a graded or modified waiting period." },

  twitter: { title: "The Life Insurance Contestability Period, Explained", description: "A professional explanation of what the standard two-year contestability period means, why it exists, and how it differs from a graded or modified waiting period." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          across the industry, not something to be alarmed by, but worth a professional
          explanation.
        </p>
