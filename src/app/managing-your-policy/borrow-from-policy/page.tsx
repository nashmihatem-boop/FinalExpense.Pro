...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how a policy loan against a whole life policy's cash value works, and what an unpaid loan does to the death benefit.",
  openGraph: { title: "Borrowing Against Your Policy's Cash Value", description: "A professional explanation of how a policy loan against a whole life policy's cash value works, and what an unpaid loan does to the death benefit." },

  twitter: { title: "Borrowing Against Your Policy's Cash Value", description: "A professional explanation of how a policy loan against a whole life policy's cash value works, and what an unpaid loan does to the death benefit." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          differently from a typical bank loan, and it&apos;s worth a professional explanation
          before you use it.
        </p>
