...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of common reasons a death benefit claim gets denied, and the options a beneficiary has, from appeal to a state complaint.",
  openGraph: { title: "What to Do If a Life Insurance Claim Is Denied", description: "A professional breakdown of common reasons a death benefit claim gets denied, and the options a beneficiary has, from appeal to a state complaint." },

  twitter: { title: "What to Do If a Life Insurance Claim Is Denied", description: "A professional breakdown of common reasons a death benefit claim gets denied, and the options a beneficiary has, from appeal to a state complaint." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          necessarily the final word. Here&apos;s a professional breakdown of the reasons it
          typically happens, and the concrete options a beneficiary has from there.
        </p>
