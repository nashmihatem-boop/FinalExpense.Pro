...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of what happens to your policy if your named beneficiary passes away first, and why naming a contingent beneficiary matters.",
  openGraph: { title: "If Your Beneficiary Dies Before You", description: "A professional explanation of what happens to your policy if your named beneficiary passes away first, and why naming a contingent beneficiary matters." },

  twitter: { title: "If Your Beneficiary Dies Before You", description: "A professional explanation of what happens to your policy if your named beneficiary passes away first, and why naming a contingent beneficiary matters." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          first, and the policy is never updated. Here&apos;s a professional explanation of what
