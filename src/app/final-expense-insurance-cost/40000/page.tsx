...
export const metadata: Metadata = {
  ...
  description:
    "A professional look at what a $40,000-and-up final expense policy is meant to cover, where final expense starts overlapping with whole life insurance, and what drives the price.",
  openGraph: { title: "$40,000 Final Expense Insurance Cost", description: "A professional look at what a $40,000-and-up final expense policy is meant to cover, where final expense starts overlapping with whole life insurance, and what drives the price." },

  twitter: { title: "$40,000 Final Expense Insurance Cost", description: "A professional look at what a $40,000-and-up final expense policy is meant to cover, where final expense starts overlapping with whole life insurance, and what drives the price." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          and more like a small whole life policy that happens to also cover one — which is
          exactly the kind of distinction a licensed professional should walk you through before
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          worth a candid, professional conversation about whether a &quot;final
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A professional coverage review is the most direct way to find out what $40,000 in
          coverage — or a larger whole life policy, if that turns out to be the better fit —
