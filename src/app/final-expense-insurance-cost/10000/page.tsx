...
export const metadata: Metadata = {
  ...
  description:
    "A professional look at what a $10,000 final expense policy commonly covers, how cremation and burial costs compare, and what actually drives the price.",
  openGraph: { title: "$10,000 Final Expense Insurance Cost", description: "A professional look at what a $10,000 final expense policy commonly covers, how cremation and burial costs compare, and what actually drives the price." },

  twitter: { title: "$10,000 Final Expense Insurance Cost", description: "A professional look at what a $10,000 final expense policy commonly covers, how cremation and burial costs compare, and what actually drives the price." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          as a baseline amount. What it actually costs isn&apos;t something a professional review
          can put on this page as a fixed rate, but what it&apos;s typically used for is fairly
          consistent.
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            A $10,000 premium is set individually, not off a rate card anyone can publish here.
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          goal, it&apos;s worth reviewing this amount against{" "}
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          total. We won&apos;t estimate numbers we can&apos;t verify, but the{" "}
          <a href="https://nfda.org" className="text-harbor-mid underline">
            National Funeral Directors Association
          </a>{" "}
          publishes national median cost data each year if you want a credible starting point for
          your own research before settling on a coverage amount.
        </p>
        ...
        <CostFactorsGrid />
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A professional coverage review is the only way to see what $10,000 in coverage actually
          costs based on your own age, health, and state — no obligation to move forward with it.
        </p>
