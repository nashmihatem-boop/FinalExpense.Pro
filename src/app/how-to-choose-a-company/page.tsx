...
export const metadata: Metadata = {
  ...
  description:
    "A professional, carrier-neutral checklist for evaluating any final expense insurance provider — licensing, track record, claims handling, and reading the actual policy before you buy.",
  openGraph: { title: "How to Choose a Final Expense Insurance Company", description: "A professional, carrier-neutral checklist for evaluating any final expense insurance provider — licensing, track record, claims handling, and reading the actual policy before you buy." },

  twitter: { title: "How to Choose a Final Expense Insurance Company", description: "A professional, carrier-neutral checklist for evaluating any final expense insurance provider — licensing, track record, claims handling, and reading the actual policy before you buy." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          a professional, carrier-neutral checklist for evaluating any company you&apos;re
          considering — not which specific companies to pick, but what to actually look for.
        </p>
        ...
        <h2 className="mt-14 font-display text-xl font-extrabold text-harbor">
          Why comparing through a licensed professional can help
        </h2>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          This is exactly the comparison a licensed professional at an independent agency is built
          to make easy. Rather than evaluating one company&apos;s policy in isolation, working
          with an independent agency lets you see how multiple carriers actually price and
          structure coverage for your specific situation, side by side, before you decide. It
          doesn&apos;t replace doing your own homework on any company you&apos;re considering —
          but it does mean you&apos;re choosing from real options instead of a single offer.
        </p>
