...
export const metadata: Metadata = {
  ...
  description:
    "A professional, balanced comparison of cost, religious and cultural considerations, and environmental factors between burial and cremation — and why final expense coverage works the same either way.",
  openGraph: { title: "Burial vs. Cremation: A Balanced Comparison", description: "A professional, balanced comparison of cost, religious and cultural considerations, and environmental factors between burial and cremation — and why final expense coverage works the same either way." },

  twitter: { title: "Burial vs. Cremation: A Balanced Comparison", description: "A professional, balanced comparison of cost, religious and cultural considerations, and environmental factors between burial and cremation — and why final expense coverage works the same either way." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          reasonable families land in different places. Here&apos;s a professional, balanced look
          at how they actually compare, and one thing that doesn&apos;t change no matter which you
