...
export const metadata: Metadata = {
  ...
  description:
    "A professional, step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage.",
  openGraph: { title: "What to Expect When Planning a Funeral", description: "A professional, step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage." },

  twitter: { title: "What to Expect When Planning a Funeral", description: "A professional, step-by-step walkthrough of the funeral planning process and the decisions — and costs — involved at each stage." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          of it has to happen all at once. Here&apos;s a professional walkthrough of the general
          sequence, and what&apos;s actually being decided, and paid for, at each step.
        </p>
