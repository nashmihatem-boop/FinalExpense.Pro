...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of what eco-friendly or green burial actually involves, and why it's often, though not always, less costly than a traditional burial.",
  openGraph: { title: "What Is Green Burial?", description: "A professional explanation of what eco-friendly or green burial actually involves, and why it's often, though not always, less costly than a traditional burial." },

  twitter: { title: "What Is Green Burial?", description: "A professional explanation of what eco-friendly or green burial actually involves, and why it's often, though not always, less costly than a traditional burial." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          cremation. Here&apos;s a professional look at what the term actually means, and how it
          tends to affect cost.
        </p>
