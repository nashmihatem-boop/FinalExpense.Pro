...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of how material, size, and engraving affect headstone and grave marker pricing, and how to get an accurate quote.",
  openGraph: { title: "What Affects Headstone & Grave Marker Cost", description: "A professional breakdown of how material, size, and engraving affect headstone and grave marker pricing, and how to get an accurate quote." },

  twitter: { title: "What Affects Headstone & Grave Marker Cost", description: "A professional breakdown of how material, size, and engraving affect headstone and grave marker pricing, and how to get an accurate quote." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          worth a professional look before you start comparing quotes.
        </p>
