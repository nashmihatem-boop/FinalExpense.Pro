...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of the factors that drive cemetery plot pricing — location, cemetery type, and fees like perpetual care — and how to get a real number.",
  openGraph: { title: "What Affects Cemetery Plot Cost", description: "A professional breakdown of the factors that drive cemetery plot pricing — location, cemetery type, and fees like perpetual care — and how to get a real number." },

  twitter: { title: "What Affects Cemetery Plot Cost", description: "A professional breakdown of the factors that drive cemetery plot pricing — location, cemetery type, and fees like perpetual care — and how to get a real number." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          completely different business with its own rules. Here&apos;s a professional breakdown
          of what actually moves that price, so you know what to ask when you call.
        </p>
