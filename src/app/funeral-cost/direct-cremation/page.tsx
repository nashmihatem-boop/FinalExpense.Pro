...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how direct cremation works, why it's generally the least expensive disposition option, and how families pair it with a memorial service on their own timeline.",
  openGraph: { title: "What Is Direct Cremation?", description: "A professional explanation of how direct cremation works, why it's generally the least expensive disposition option, and how families pair it with a memorial service on their own timeline." },

  twitter: { title: "What Is Direct Cremation?", description: "A professional explanation of how direct cremation works, why it's generally the least expensive disposition option, and how families pair it with a memorial service on their own timeline." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          than because anything is cut short. Here&apos;s a professional look at what&apos;s
          actually included, why it tends to cost less, and how families often build a separate
          memorial around it.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          The honest, professional answer depends on what matters most: simplicity and a lower
          cost, or having a body present for a traditional service beforehand. Neither is more
          correct than the other. What matters practically is making sure whichever path you lean
          toward is reflected in your final expense coverage and communicated to whoever will be
          handling arrangements, so your wishes are honored without anyone having to guess.
        </p>
