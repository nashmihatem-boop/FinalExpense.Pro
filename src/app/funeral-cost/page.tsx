...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number from local providers before you size coverage.",
  openGraph: { title: "Funeral Cost Guide", description: "A professional breakdown of why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number from local providers before you size coverage." },

  twitter: { title: "Funeral Cost Guide", description: "A professional breakdown of why funeral costs vary so much, the general categories you're actually paying for, and how to get a real number from local providers before you size coverage." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          your family can make. This professional guide covers why costs vary, the general
          categories you&apos;re actually paying for, and where to go for a real, current number.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          named beneficiary, so the practical, professional approach is to get a current, itemized
          estimate, add a cushion for the unexpected, and size your coverage to that total rather
          than a guess.
        </p>
