...
export const metadata: Metadata = {
  ...
  description:
    "A professional look at why casket prices vary so much — material and craftsmanship — and your legal right to buy one from outside the funeral home.",
  openGraph: { title: "What Affects the Cost of a Casket", description: "A professional look at why casket prices vary so much — material and craftsmanship — and your legal right to buy one from outside the funeral home." },

  twitter: { title: "What Affects the Cost of a Casket", description: "A professional look at why casket prices vary so much — material and craftsmanship — and your legal right to buy one from outside the funeral home." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          you have that figure, or even a realistic range, a licensed professional can help you
          size a final expense policy around it, with enough cushion left for the rest of the
          arrangements too.
        </p>
