...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of the real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to get an accurate number for your area.",
  openGraph: { title: "What Affects the Cost of Cremation", description: "A professional breakdown of the real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to get an accurate number for your area." },

  twitter: { title: "What Affects the Cost of Cremation", description: "A professional breakdown of the real factors that move cremation pricing up or down — service type, urn choice, and provider — and how to get an accurate number for your area." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          makes any single published number close to meaningless. What&apos;s more useful is a
          professional understanding of the specific factors that push a cremation toward the
          simple, lower end or the more involved, higher end — so you know what to ask when you
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          local prices shifted. The professional move is to call a provider or two in your area,
          ask for an itemized quote, and use that real number to size a final expense policy that
