...
export const metadata: Metadata = {
  ...
  description:
    "A professional checklist for how to check a carrier's and agent's state insurance license, confirm an NPN, and spot payment requests that no legitimate insurance company would ever make.",
  openGraph: { title: "How to Verify an Insurance Company Is Legitimate", description: "A professional checklist for how to check a carrier's and agent's state insurance license, confirm an NPN, and spot payment requests that no legitimate insurance company would ever make." },

  twitter: { title: "How to Verify an Insurance Company Is Legitimate", description: "A professional checklist for how to check a carrier's and agent's state insurance license, confirm an NPN, and spot payment requests that no legitimate insurance company would ever make." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          professional checks are enough to confirm you&apos;re actually dealing with who you
          think you are. None of them take more than a few minutes, and every one of them is free.
        </p>
