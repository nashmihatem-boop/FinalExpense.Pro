...
export const metadata: Metadata = {
  ...
  description:
    "A professional explanation of how churning — replacing a policy you already have mainly to generate a new commission — can cost you a new contestability period and lost cash value.",
  openGraph: { title: "What Is Policy Churning, and How Do You Avoid It?", description: "A professional explanation of how churning — replacing a policy you already have mainly to generate a new commission — can cost you a new contestability period and lost cash value." },

  twitter: { title: "What Is Policy Churning, and How Do You Avoid It?", description: "A professional explanation of how churning — replacing a policy you already have mainly to generate a new commission — can cost you a new contestability period and lost cash value." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          professional checks, not just to a friendly conversation.
        </p>
