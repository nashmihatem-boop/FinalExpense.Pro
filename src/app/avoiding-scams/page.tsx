...
export const metadata: Metadata = {
  ...
  description:
    "A professional breakdown of why final expense insurance draws scammers, how to verify a company is legitimate, and six specific things to check before you buy or switch a policy.",
  openGraph: { title: "Avoiding Final Expense Insurance Scams", description: "A professional breakdown of why final expense insurance draws scammers, how to verify a company is legitimate, and six specific things to check before you buy or switch a policy." },

  twitter: { title: "Avoiding Final Expense Insurance Scams", description: "A professional breakdown of why final expense insurance draws scammers, how to verify a company is legitimate, and six specific things to check before you buy or switch a policy." },
};
...
const TOPICS = [
  ...
  },
  {
    ...
    description:
      "A professional, honest explanation of a captive agent, an independent agent, and buying direct from a carrier.",
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          professionally researched guide covers what to watch for, however you end up buying.
        </p>
