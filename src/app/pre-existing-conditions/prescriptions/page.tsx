...
export const metadata: Metadata = {
  ...
  description: "A professional explanation of why the medications you take can matter as much as the diagnosis behind them when applying for final expense insurance.",
  openGraph: {
    title: "How Prescription History Affects Your Application",
    description: "A professional explanation of why the medications you take can matter as much as the diagnosis behind them when applying for final expense insurance.",
  },
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          review — here&apos;s a professional breakdown of why, and what it means for a few of
