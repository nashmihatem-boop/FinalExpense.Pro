...
export const metadata: Metadata = {
  ...
  description:
    "A factual, respectful, professional explanation of how life insurance policies handle death by suicide, including the standard exclusion period.",
  openGraph: { title: "Does Life Insurance Cover Suicide?", description: "A factual, respectful, professional explanation of how life insurance policies handle death by suicide, including the standard exclusion period." },

  twitter: { title: "Does Life Insurance Cover Suicide?", description: "A factual, respectful, professional explanation of how life insurance policies handle death by suicide, including the standard exclusion period." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          ...
          professional, factual answer — along with a resource if you or someone you know needs
          support right now.
        </p>
