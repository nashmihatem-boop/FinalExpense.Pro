...
export const metadata: Metadata = {
  ...
  description:
    "You likely haven't aged out. A professional look at applying for final expense insurance in your 80s, including when guaranteed issue makes sense.",
  openGraph: { title: "Final Expense Insurance in Your 80s", description: "You likely haven't aged out. A professional look at applying for final expense insurance in your 80s, including when guaranteed issue makes sense." },

  twitter: { title: "Final Expense Insurance in Your 80s", description: "You likely haven't aged out. A professional look at applying for final expense insurance in your 80s, including when guaranteed issue makes sense." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-8 text-lg leading-relaxed text-charcoal/80">
          ...
          this age, just with a couple of things a licensed professional should walk you through
          upfront.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          the next, so rather than assuming you&apos;re past the cutoff, it&apos;s worth having a
          professional actually check — &quot;too old&quot; is a myth more often than it&apos;s a
          fact at this stage.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          It&apos;s worth having your health answers actually reviewed by a licensed professional
