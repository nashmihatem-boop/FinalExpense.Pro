...
export const metadata: Metadata = {
  ...
  description:
    "A professional, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them.",
  openGraph: { title: "Traditional Funeral vs. Direct Burial", description: "A professional, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them." },

  twitter: { title: "Traditional Funeral vs. Direct Burial", description: "A professional, honest comparison of what a traditional funeral includes versus direct burial, why the cost differs, and how families decide between them." },
};
