...
export const metadata: Metadata = {
  ...
  description:
    "A professional, honest look at final expense coverage for a child — a different, much smaller product than senior final expense insurance.",
  openGraph: { title: "Final Expense Insurance for a Child", description: "A professional, honest look at final expense coverage for a child — a different, much smaller product than senior final expense insurance." },

  twitter: { title: "Final Expense Insurance for a Child", description: "A professional, honest look at final expense coverage for a child — a different, much smaller product than senior final expense insurance." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          If you searched for this, a professional answer is owed upfront: what people usually mean
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          rest of this site focuses on. We&apos;d rather say that plainly, as any licensed
          professional should, than stretch our usual content to fit a situation it wasn&apos;t
          written for.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          options work all vary by carrier, so this is very much a &quot;get a professional
          opinion on the specifics&quot; kind of product.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          ...
          reason, ideally with professional guidance, rather than out of a sense that every family
          &quot;needs&quot; one.
        </p>
