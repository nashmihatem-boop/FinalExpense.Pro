...
export const metadata: Metadata = {
  ...
  description:
    "Every guide on FinalExpense.Pro in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, written and reviewed by professionals.",
  openGraph: { title: "Final Expense Insurance Guides & Resources", description: "Every guide on FinalExpense.Pro in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, written and reviewed by professionals." },

  twitter: { title: "Final Expense Insurance Guides & Resources", description: "Every guide on FinalExpense.Pro in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, written and reviewed by professionals." },
};
...
const BASICS: LinkItem[] = [
  ...
  { href: "/life-insurance-glossary", title: "Life insurance glossary", description: "Precise definitions for the terms that come up in every other guide." },
  ...
  { href: "/how-to-choose-a-company", title: "How to choose a company", description: "A professional, carrier-neutral checklist for evaluating any insurer." },
...
const COMPARISONS: LinkItem[] = [
  { href: "/final-expense-vs-term-life", title: "Final expense vs. term life", description: "Two very different products that both get called \"life insurance,\" assessed side by side." },
  ...
  { href: "/traditional-funeral-vs-direct-burial", title: "Traditional funeral vs. direct burial", description: "A precise, no-figures comparison of the two paths." },
];
...
const HARD_QUESTIONS: LinkItem[] = [
  ...
  { href: "/does-life-insurance-cover-suicide", title: "Does life insurance cover suicide?", description: "A precise, respectful explanation of the contestability-period rule." },
  ...
  { href: "/reduce-funeral-costs", title: "How to reduce funeral costs", description: "Legitimate, professionally vetted ways to lower the bill without cutting corners." },
...
const BY_AGE: LinkItem[] = [
  ...
  { href: "/final-expense-insurance/is-it-worth-it", title: "Is it worth it?", description: "A precise, balanced look at who this product is, and isn't, built for." },
